...
def cache_checkout_data(request):
    """
    Cache checkout data and modify the PaymentIntent metadata
    to include cart, save_info, and username.
    """
...
def checkout(request):
    """
    Render the checkout page with the order form and process
    the checkout if the form is valid.
    """
